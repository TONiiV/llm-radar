...
const translations = {
  zh: {
    ...
    model: {
      ...
      partialData: "部分数据",
      compareWithOthers: "与其他模型对比 →",
      capabilityScores: "能力评分",
      benchmarkDetails: "基准测试详情",
      noData: "— 暂无数据",
      pricing: "价格",
      inputPer1M: "输入 / 百万 token",
      outputPer1M: "输出 / 百万 token",
      typicalQueryCost: "典型查询成本",
      reasoningTokensDesc: "1K 输入 + 5K 输出 token（推理）",
      standardTokensDesc: "1K 输入 + 500 输出 token",
      estimatedPrice: "~ = 估算价格",
      specifications: "规格",
      provider: "供应商",
      releaseDate: "发布日期",
      contextInput: "上下文（输入）",
      contextOutput: "上下文（输出）",
      openSource: "开源",
      reasoningModel: "推理模型",
      yes: "是",
      no: "否",
  ...
  en: {
    ...
    model: {
      ...
      typicalQueryCost: "Typical query cost",
      reasoningTokensDesc: "1K input + 5K output tokens (reasoning)",
      standardTokensDesc: "1K input + 500 output tokens",
